...
<head>
    ...
    <title>Login | LAPOR PAK! PT. GDSK</title>
    <!-- icon diskominfo -->
...
<body>
    <div class="container">
        <div class="row content">
            ...
            <div class="col-md-6">
                <a class="btn logo" href="../index.php">LAPOR PAK!</a>
                <img src="../assets/img/logo-gdsk.svg" width="100" height="100">
                <p class="lead">Gobel Dharma Sarana Karya</p>
                ...
                <form action="" method="post">
                    ...
                    <a href="../index.php" class="btn btn-signup">Back</a>
                </form>
                <br><center><p>Develop by <a href='' title='kelompok 8' target='_blank'>Kelompok 8</a></p></center>
