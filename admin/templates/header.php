...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/img/logo-gdsk.svg" alt="LOGO" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 19px;">LAPOR PAK! PT. GDSK</span>
    </a>
